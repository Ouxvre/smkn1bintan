...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="../dashboard/gallery.php" class="bg-primary"><i class="fa fa-images"></i> Gallery</a>
        <a href="../dashboard/ekstrakurikuler.php"><i class="fa fa-school"></i> Ekstrakurikuler</a>
